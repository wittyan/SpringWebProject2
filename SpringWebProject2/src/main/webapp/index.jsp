...
<!-- Top Background Image Wrapper -->
	<div class = "background" style="background-image:url('images/demo/backgrounds/livhead.jpg');
	background-repeat:no-repeat;
	background-size:100% 100%;
	background-position:center;">
	  <div id="loginheader"   class="overlay"  style="margin-right:60px;width:100%; height:50px;">
	...
	<div  class="bgded overlay padtop" > 
	  ...
	  <!-- ################################################################################################ -->
	  <!-- ################################################################################################ -->
	  <header id="header" class="hoc clear" style="margin-top:0px; padding-top:0px">
	  ...
	  <main class="hoc container clear"> 
	    ...
	    <section id="services">
	      ...
	      <ul class="nospace group grid-3">
	        <li class="one_third">
	          <article><a href="./pages/gallery.jsp"><i class="fas fa-spray-can"></i></a>
	        ...
	        <li class="one_third">
	          <article><a href="http://cycling.or.kr/"><i class="fas fa-crow"></i></a>
	            <h6 class="heading">대한 자전거 연맹</h6>
	            <p>대한 자전거 연맹에서는 연맹은 올림픽의 꿈을 위한 엘리트 육성 인프라 구축사업과 동호인 자전거 활성화 사업을 적극 추진하며, 
	            엘리트와 동호인, 두 개의 축이 하나가 되는 진정한 국민적 인기스포츠로 성장할 수 있도록 최선을 다하고 있습니다.</p>
	            <footer><a href="#">More Details &raquo;</a></footer>
	          </article>
	        </li>
	        <li class="one_third">
	          <article><a href="http://www.kmtb.or.kr/"><i class="fas fa-dolly-flatbed"></i></a>
	            <h6 class="heading">한국산악자전거협회</h6>
	            <p> 산악자전거를(MOUNTAIN BIKE) 통하여 자연환경을 보존하고, 심신을 단련 시키며, MTB문화를 레져 스포츠로 접목시켜 대중적 문화로 승화시키려 노력하고 있습니다.</p>
	            <footer><a href="#">More Details &raquo;</a></footer>
	          </article>
	        </li>
	        <li class="one_third">

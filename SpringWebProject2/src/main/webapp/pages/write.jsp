...
<body id="top">
	...
	<div class="wrapper row3">
		...
		<div id="contents" class="content three_quarter">
			...
			<div id="qnaRegi">
				<h1 align="center"
					style="font-weight: bold; size: 50px; margin-top: 50px;">글쓰기</h1>
				<form action="insert.do?page=${param.page }" name="qnaFrm" method="POST"
					...
					<a id="regbtn" class="btn btn-default pull-right">등록하기</a>
					<a href="/community.do?${param.page }"class="btn btn-default pull-left">목록으로</a>
				</form>
			</div>
